function stat_1st_block_2ses (prefix, basefmriname, kTR, mocoRegress)
...
names{2} = 'rightTap';
%c{session, cond}
onsets{1,1} = [0 52.797 105.594 158.406 211.203 264 265.094];
onsets{1,2} = [26.406 79.203 132 184.797 237.594];
%if two sessions....
onsets{2,1} = [26.8770   79.6740  132.4860  185.2830  238.0800  239.1740];
onsets{2,2} = [0.4860   53.2830  106.0800  158.8770  211.6740  264.4860];
